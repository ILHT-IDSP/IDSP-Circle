...
const MusicLocationTag: React.FC<MusicLocationTagProps> = ({ song, artist, location }) => {
	return (
		<div className='flex flex-col items-center rounded-lg w-full max-w-xs p-2 md:p-3 bg-foreground text-background'>
			<div className='flex items-center mb-1 w-full justify-center'>
				{' '}
				<FaMusic className='mr-1.5 md:mr-2 text-xs md:text-sm flex-shrink-0 text-primary' />
			...
			<div className='flex items-center text-xs w-full justify-center'>
				{' '}
				<FaMapMarkerAlt className='mr-1.5 md:mr-2 text-xs flex-shrink-0 text-primary' />
