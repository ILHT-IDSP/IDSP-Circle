...
const ProfileContainer: React.FC<ProfileContainerProps> = ({ profileImage, userName, circlesCount, friendsCount }) => {
	return (
		<div className='flex flex-col items-center w-fit justify-end flex-shrink-0 bg-accent'>
