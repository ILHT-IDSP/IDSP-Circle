            ...
            {circleInvites.map((invite) => (
                <div key={invite.id} className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                        <button className="bg-circles-dark-blue text-circles-light font-semibold py-1 px-3 rounded-lg">
                            accept
                        </button>
                        <button className="bg-gray-600 text-circles-light font-semibold py-1 px-3 rounded-lg">
                            decline
                        </button>
                    </div>
                </div>
